...
*Impossible Box de México S.A.S. de C.V.* mejor conocido como Impossible Box de México, con domicilio en Tlaxcala 55, Centro, Papalotla de Xicohténcatl, Tlaxcala, México y portal de internet impossiblebox.com.mx, es el responsable del uso y protección de sus datos personales, y al respecto le informamos lo siguiente:
...
Datos de identificación y contacto, datos laborales, datos académicos, datos migratorios, datos patrimoniales y/o financieros.
...
Para el ejercicio de cualquiera de los derechos ARCO, debe enviar una petición vía correo electrónico a nosotros@impossiblebox.com.mx y deberá contener:
Nombre completo del titular.Domicilio.Teléfono.Correo electrónico usado en este sitio web.Copia de una identificación oficial adjunta.Asunto «Derechos ARCO»
...
Le informamos que en nuestra página de internet y en la Estantería Digital de Papalotla utilizamos cookies, web beacons u otras tecnologías, a través de las cuales es posible monitorear su comportamiento como usuario de internet, así como brindarle un mejor servicio y experiencia al navegar en nuestra página. Los datos personales que obtenemos de estas tecnologías de rastreo son los siguientes:
Tipo de navegador del usuario, fecha y hora del inicio y final de una sesión de un usuario.
